...
This design keeps the skill files portable. The same `.orkestr/skills/code-style.md` file works across projects without modification -- only the per-project variable values change.
